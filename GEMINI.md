...
- **Agent Name:** lead-overstory-899f
- **Task ID:** overstory-899f
- **Spec:** No spec file provided
- **Branch:** overstory/lead-overstory-899f/overstory-899f
- **Worktree:** /home/iamzubin/Work/overstory/.overstory/worktrees/lead-overstory-899f
- **Parent:** coordinator
- **Depth:** 0
...
Your worktree root is: `/home/iamzubin/Work/overstory/.overstory/worktrees/lead-overstory-899f`

**CRITICAL**: All file operations MUST use paths within this directory.
- Use paths relative to your worktree root, or absolute paths starting with `/home/iamzubin/Work/overstory/.overstory/worktrees/lead-overstory-899f`
...
These paths are relative to your worktree root: `/home/iamzubin/Work/overstory/.overstory/worktrees/lead-overstory-899f`
...
Use `ov mail` for all communication. Your address is **lead-overstory-899f**.

```bash
# Check your inbox (do this regularly)
ov mail check --agent lead-overstory-899f

# Send a status update to your parent
ov mail send --to coordinator --subject "status" \
  --body "Progress update here" --type status --agent lead-overstory-899f

# Ask a question
ov mail send --to coordinator --subject "question" \
  --body "Your question here" --type question --priority high --agent lead-overstory-899f

# Report completion
ov mail send --to coordinator --subject "done" \
  --body "Summary of what was done" --type result --agent lead-overstory-899f

# Reply to a message
ov mail reply <message-id> --body "Your reply" --agent lead-overstory-899f
```
...
ov sling <task-id> --capability builder --name <worker-name> \
  --parent lead-overstory-899f --depth 1
```
...
4. **Commit:** all changes committed to your branch (overstory/lead-overstory-899f/overstory-899f)
5. **Record mulch learnings:** `ml record <domain> --type <convention|pattern|failure|decision> --description "..." --outcome-status success --outcome-agent lead-overstory-899f` — capture insights from your work
6. **Signal completion:** send `worker_done` mail to coordinator: `ov mail send --to coordinator --subject "Worker done: overstory-899f" --body "Quality gates passed." --type worker_done --agent lead-overstory-899f`
7. **Close issue:** `sd close overstory-899f --reason "summary of changes"`
...
- **WORKTREE ISOLATION**: All writes MUST target files within your worktree at `/home/iamzubin/Work/overstory/.overstory/worktrees/lead-overstory-899f`
- NEVER write to the canonical repo root — all writes go to your worktree copy
- Only modify files in your File Scope
- Commit only to your branch: overstory/lead-overstory-899f/overstory-899f
